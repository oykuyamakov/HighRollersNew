...
namespace RootMotion.Dynamics {
	...
	public class RagdollEditorInspector : Editor {
		...
		public override void OnInspectorGUI() {
			...
			GUILayout.BeginHorizontal();
			if (GUILayout.Button(new GUIContent("SetInitial All Kinematic", "Enables 'Is Kinematic' on all child Rigidbodies."))) {
				Rigidbody[] rigidbodies = GetRigidbodies();
				Undo.RecordObjects(rigidbodies, "SetInitial All Kinematic");
			...
			if (GUILayout.Button(new GUIContent("SetInitial All Non-Kinematic", "Disables 'Is Kinematic' on all child Rigidbodies."))) {
				Rigidbody[] rigidbodies = GetRigidbodies();
				Undo.RecordObjects(rigidbodies, "SetInitial All Non-Kinematic");
