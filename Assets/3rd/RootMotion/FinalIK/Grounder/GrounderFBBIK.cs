...
namespace RootMotion.FinalIK {
	...
	public class GrounderFBBIK: Grounder {
		...
		private void Initiate () {
			// SetInitial maintainRotationWeight to 1 for both limbs so their rotation will be maintained as animated
		...
		private void OnSolverUpdate() {
			...
			// SetInitial effector positionOffsets for the feet
		...
		// SetInitial the effector positionOffset for the foot
