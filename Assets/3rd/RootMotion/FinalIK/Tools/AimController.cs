...
namespace RootMotion.FinalIK {
	...
	public class AimController : MonoBehaviour {
		...
		[Tooltip("The target to aim at. Do not use the Target transform that is assigned to AimIK. SetInitial to null if you wish to stop aiming.")]
		/// <summary>
		/// The target to aim at. Do not use the Target transform that is assigned to AimIK. SetInitial to null if you wish to stop aiming.
		/// </summary>
