...
namespace RootMotion.Demos {
	...
	public class MotionAbsorb : OffsetModifier {
		...
		public class Absorber {
			...
			// SetInitial effector position and rotation to match its bone
			...
			// SetInitial effector position and rotation weight to match the value, multiply with the weight of this Absorber
			public void UpdateEffectorWeights(float w) {
				e.positionWeight = w * weight;
				e.rotationWeight = w * weight;
			}

			// SetInitial effector positionOffset to match the position, multiply with the weight of this Absorber
			public void SetPosition(float w) {
				e.positionOffset += (position - e.bone.position) * w * weight;
			}

			// SetInitial effector bone rotation to match the rotation, multiply with the weight of this Absorber
		...
		protected override void OnModifyOffset() {
			...
			// SetInitial the weights of the effectors
