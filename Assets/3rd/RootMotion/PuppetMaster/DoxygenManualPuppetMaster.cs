...
<h1>Component interface:</h1>
	...
	- <b>SetInitial All Kinematic</b> - set all Rigidbodies kinematic.
	- <b>SetInitial All Non-Kinematic</b> - set all Rigidbodies non-kinematic.
...
To set up a character with ragdoll components as a Puppet, the easiest way is to simply add the PuppetMaster component to it and click on the "SetInitial Up PuppetMaster" button.
...
<br>
	...
	- SetInitial PuppetMaster mode to "Disabled" for puppets when they don't need any physics simulation.
	- SetInitial PuppetMaster mode to "Kinematic" for puppets that only need the colliders for collision detection or raycasting.
