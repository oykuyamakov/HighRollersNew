    ...
    */
    ...
    public class CustomControllerDemo : MonoBehaviour {
        ...
        private void Initialize() {
            ...
            // SetInitial up arrays to store our current source element values
            ...
            // SetInitial callbacks to retrieve current element values.
        ...
        private void OnInputSourceUpdate() {
            ...
            // SetInitial the current values directly in the controller
        ...
        private void SetControllerAxisValues() {
            // SetInitial the element values directly in the controller
            for(int i = 0; i < axisValues.Length; i++) {
