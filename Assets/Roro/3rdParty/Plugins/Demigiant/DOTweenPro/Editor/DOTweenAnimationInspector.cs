...
//                _src.animationType = (DOTweenAnimation.AnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
                ...
                if (prevAnimType != _src.animationType) {
                    // SetInitial default optional values based on animation type
                ...
                _src.loops = EditorGUILayout.IntField(new GUIContent("Loops", "SetInitial to -1 for infinite loops"), _src.loops);
