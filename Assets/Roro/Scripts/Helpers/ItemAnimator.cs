...
namespace Based.Utility
{
    public class ItemAnimator : MonoBehaviour
    {
        ...
        [SerializeField]
        private SpriteSheetAnimator m_False;
        [SerializeField]
        private SpriteSheetAnimator m_Semi;
        [SerializeField]
        private SpriteSheetAnimator m_Correct;
        ...
        private static Stack<SpriteSheetAnimator> m_CorrectSpriteSheet = new Stack<SpriteSheetAnimator>();
        private static Stack<SpriteSheetAnimator> m_FalseSpriteSheet = new Stack<SpriteSheetAnimator>();
        private static Stack<SpriteSheetAnimator> m_SemiSpriteSheet = new Stack<SpriteSheetAnimator>();
        ...
        public static void AnimateSpriteSheet(Stack<SpriteSheetAnimator> stack, Vector3 pos)
        {
            var s = stack.Pop();
            s.EnableSelf();
