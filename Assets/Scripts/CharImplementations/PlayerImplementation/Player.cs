...
namespace CharImplementations.PlayerImplementation
{
    public class Player : Character
    {
        ...
        public override void Move()
        {
            ...
            CharacterController.SimpleMove((MoveDir.normalized * (MoveSpeed * Time.deltaTime * (InvertedControls ? -1 : 1))));
        ...
        private void ChangeWeapon()
        {
            ...
            using var wEvt = WeaponChangeEvent.Get(WeaponData, oldWeaponData);
            wEvt.SendGlobal();
        }
        ...
        private void TryDodge(SlideEvent evt)
        {
            ...
            var pos = transform.position +  (dodgeDir * DodgeDistance);
