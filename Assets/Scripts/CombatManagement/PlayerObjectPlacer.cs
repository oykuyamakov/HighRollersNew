...
namespace CombatManagement
{
    ...
    public class PlayerObjectPlacer : MonoBehaviour
    {
        ...
        protected void OnEnable()
        {
            ...
            GEM.AddListener<CancelFateAttackEvent>(OnCanceled);
        }
        ...
        public void ClampObjectPosition()
        {
            ...
            PlaceableBehaviour.AssignMaterial(PlaceableBehaviour.Placeable
        ...
        // TODO: refactor
        public virtual void OnCanceled(CancelFateAttackEvent evt)
        {
            if (!m_Active)
                return;
            ...
            Time.timeScale *= 2f;
            m_PlaceObjectPromise.Fail();

            PlaceableBehaviour.gameObject.Destroy();
        ...
        {
            GEM.RemoveListener<PlayerInitializedEvent>(OnPlayerInitialized);
            GEM.RemoveListener<ActivatePlayerObjectPlacerEvent>(OnActivatePlayerObjectPlacer);
            GEM.RemoveListener<CancelFateAttackEvent>(OnCanceled);
        }
    }
}